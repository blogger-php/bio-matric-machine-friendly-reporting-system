<?php 
  ...
  $roster_family = "SELECT assign_roster_family.roster_family_id,assign_roster_family.date_created 
                    FROM assign_roster_family
                    RIGHT JOIN assign_roster
                    ON assign_roster_family.roster_id=assign_roster.roster_id 
                    WHERE user_id=".$user_id;

  $roster_family_result = mysql_query($roster_family);
  $roster_family_row = mysql_fetch_assoc($roster_family_result);

  $roster_family_id = $roster_family_row['roster_family_id'];

  $assign_roster_date_created =  $roster_family_row['date_created'];

 //echo $roster_family_row."<br>";
 //echo $assign_roster_date_created."<br>";

  ///////////////// Roster info according to the assigned family

  $query = "SELECT assign_roster_family.roster_id,roster_family.days FROM assign_roster_family 
            LEFT JOIN roster_family 
            ON assign_roster_family.roster_family_id = roster_family.id 
            WHERE roster_family.id='".$roster_family_id."' ";
 ...
 {
    $total_rosters[] =  $value['roster_id'];

    $day_of_roster = $value['days'];
 }
  // echo "<pre>";
  // print_r($total_rosters);
  // echo $day_of_roster;
 //////////////////  
    $yourInt=7;
    $remainder=$yourInt % 3;

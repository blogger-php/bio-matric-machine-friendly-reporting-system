	...
	else 
	{
	    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) 
	    {
	        $query = "UPDATE users SET firstname='".$first_name."',
	        			lastname='".$last_name."',designation='".$designation."',
	        			department='".$department."',account_type='".$account_type."',
	        			image='".$image_name."',update_date='".date("y-m-d")."',
	        			update_time='".date("H:i:s")."' WHERE id=".$_SESSION['user_id'];
